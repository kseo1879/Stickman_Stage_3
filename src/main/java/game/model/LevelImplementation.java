 ...
 */
public class LevelImplementation implements Level, Serializable {

    /**
     * The controllable entity associated with the level
     */
    private Controllable hero;
    private LevelImplementation savedLevel;
    ...
    @Override
    public Level save() {
        savedLevel = (LevelImplementation) deepClone(this);
        return savedLevel;
    }
    ...
    /**
     * Saved time is the duration of the saved time for the saved level.
     */
    @Override
    public void saveTime(int a){
        savedTime = a;
    }

    /**
     * This will return the duration of the saved time
     */
    @Override
    public int getTime(){
        return savedTime;
    ...
    /**
     * This method will deepCopy the whole level class.
     * Level class and its instances has implmented or extended Serializable in order for this to happen
     * This source is from:
     * https://www.journaldev.com/17129/java-deep-copy-object?fbclid=IwAR3lHEDoQsBOtulWUhjpOO45pBAU_L9bjaQTGlT6WKLFRNjtTAnTipQz-uY
     */
