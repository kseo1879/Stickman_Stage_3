...
public interface Level extends Serializable {
    ...
    /**
     * This will set the target time of each level
     */
    void setTargetTime(double targetTime);

    /**
     * This will be true when the enemy is killed to ensure that score is being updated
     */
    boolean enemyDead();

    /**
     * This will give information to the target time the GameEngine class
     */
    double getTargetTime();

    /**
     * This will save the current level
     */
    Level save();

    /**
     * This will save the duration of the currentLebel
     */
    void saveTime(int a);

    /**
     * This will return the savedTime
     */
    int getTime();
